...
// const basePath = 'public/content/courses'
// const contentFolder = 'introduction-to-javascript'

// const truthyFilter = el => el
// const getJsonData = buffer => JSON.parse(buffer.toString())
// const createIsMetaFile = (filename = 'meta.json') => dirent => dirent.isFile() && dirent.name === filename
// const isMarkdownFile = dirent => dirent.isFile() && dirent.name.match(/\.md$/i)[0]
// const isDirectory = dirent => dirent.isDirectory()
// const readFile = (currentFolderAbsolutePath, fileName) => fs.promises.readFile(path.resolve(currentFolderAbsolutePath, fileName)).then(getJsonData)
